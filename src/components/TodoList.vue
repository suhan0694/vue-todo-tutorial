...
export default {
    ...
    data() {
        return {
            ...
            filter: 'all',
            todos: [
                { id: 1, title: "Test 1", completed: false, editing: false },
                { id: 2, title: "Test 2", completed: false, editing: false },
            ],
        };
    },
    methods: {
    ...
    created(){
        ...
        eventBus.$on('filterChanged', (filtered) => this.filter = filtered);
    ...
    beforeDestroy() {
        ...
        eventBus.$off('filterChanged', (filtered) => this.filter = filtered);
